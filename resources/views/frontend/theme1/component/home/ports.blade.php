@php
    ...
    $services = !empty($data) ? $data :  [
        (object) [
         ...
         (object) [
            'title' => 'Port Suez Canal Container Terminal',
         ...
         (object) [
            'title' => 'Autonomous Port of Abidjan, Directorate General',
