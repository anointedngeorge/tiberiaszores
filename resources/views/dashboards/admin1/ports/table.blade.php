                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary btn-sm mb-2" onclick="loadModalPage();"
                                ...
                                data-page="{{ route('content.edit', ['content' => $obj->id, 'page_name' => 'ports', 'page_title' => 'Edit Port']) }}"
                                data-title="Edit Services">edit
                            </button>

                            <form
                                action="{{ route('content.delete', ['content' => $obj->id, 'type_name' => 'settings', 'page_name' => 'ports']) }}"
