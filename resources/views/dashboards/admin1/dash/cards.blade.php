        ...
        <div class="row">
                ...
                <div class="card gradient-1 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $count->volunteers }}</h2>
                            <span class="fs-18">Total Volunteers</span>
                        </div>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-2 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $count->partners }}</h2>
                            <span class="fs-18">Total Partners</span>
                        </div>
                        <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-3 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $count->blogs }}</h2>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-4 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $count->events }}</h2>
                            <span class="fs-18">Total Events</span>
                        </div>
