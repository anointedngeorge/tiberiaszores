                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary btn-sm mb-2" onclick="loadModalPage();"
                                ...
                                data-page="{{ route('content.edit', ['content' => $obj->id, 'page_name' => 'sliders', 'page_title' => 'Edit Service']) }}"
                                data-title="Edit Services">edit
                            </button>

                            <form
                                action="{{ route('content.delete', ['content' => $obj->id, 'type_name' => 'frontend', 'page_name' => 'sliders']) }}"
