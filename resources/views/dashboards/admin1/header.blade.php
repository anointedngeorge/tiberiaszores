...
<head>
   <!-- Title -->
	...
	<meta name="keywords" content="{{ asset(config('dash_meta')) }}">
	<meta name="description" content="{{ asset(config('data.meta_description')) }}">

	<meta property="og:title" content="{{ asset(config('data.meta')) }}">
	<meta property="og:description" content="{{ asset(config('data.meta_description')) }}">
	<meta property="og:image" content="{{ asset(config('data.logo')) }}">
	...
	<!-- Favicon icon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset(config('data.logo') ) }}">

	<link href="{{ asset('innap/vendor/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
	<link rel="stylesheet" href="{{ asset('innap/vendor/chartist/css/chartist.min.css') }}">
	<link href="{{ asset('innap/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet">

	<link rel="stylesheet" href="{{ asset('innap/vendor/toastr/css/toastr.min.css') }}">
	<link href="{{ asset('innap/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">

   <link href="{{ asset('innap/css/style.css') }}" rel="stylesheet">
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							{{-- @include("dashboards.admin1.notifications.message") --}}
...
@include('dashboards.admin1.components.navigation')