        ...
        <div class="row page-titles">
            <div class="col-md-6 col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active"><a href="javascript:void(0)">Partnership Listing</a></li>
                </ol>
            </div>
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <button 
                    ...
                    data-page="{{ route('partners.create') }}"
                                ...
                                <tbody>
                                    @foreach ($results as $result)
                                        <tr>
                                            ...
                                            <td><img src="/storage/{{ $result->image }}" alt="{{ $result->name }}" width="50" height="50"></td>
                                            <td>{{$result->name}}</td>
                                            <td>
                                                {{ $result->email }}
                                            </td>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            data-bs-toggle="modal" 
                                                            data-bs-target="#pagemodal"
                                                            data-page="{{ route('partners.edit', ['partner'=>$result->id]) }}"
                                                        ...
                                                        <td>
                                                            <form action="{{ route('partners.destroy', ['partner'=> $result->id]) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
