                        ...
                        <div class="card-body">
                            <form action="{{ route('content.store', ['type_name'=>'offices', 'page_name'=>'settings']) }}" method="post">
                                ...
                                <div class="row">
                                    <div>
                                        <label>Phone 1</label>
                                        <input value="{{ $object->phone1 ?? 'sitename'}}" placeholder="Phone number 1"
                                            class="form-control form-control-sm" type="tel" name="phone1">
                                    </div>
                                    <div class="mt-2">
                                        <label>Email Address 1</label>
                                        <input value="{{ $object->email_address1 ?? 'support@example' }}"
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input value="{{ $object->address1 ?? 'support@example' }}"
                                ...
                                <div class="row">
                                    <div>
                                        <label>Phone 2</label>
                                        <input value="{{ $object->phone2 ?? 'sitename'}}" placeholder="Phone number 2"
                                            class="form-control form-control-sm" type="tel" name="phone2">
                                    </div>
                                    <div class="mt-2">
                                        <label>Email Address 2</label>
                                        <input value="{{ $object->email_address2 ?? 'support@example' }}"
                                            placeholder="support@example.com" class="form-control form-control-sm"
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input value="{{ $object->address2 ?? 'support@example' }}"
